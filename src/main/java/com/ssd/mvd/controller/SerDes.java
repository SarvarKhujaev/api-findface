...
public class SerDes implements Runnable {
    ...
    private final Function< String, Mono< String > > test = base64 -> HttpClient
            .create()
            .headers( h -> {
                h.clear();
    ...
    public void setInsurance ( String gosno, CarTotalData carTotalData ) {
        this.getHttpClient()
                .headers( h -> {
                    h.clear();
                    h.add( "Authorization", "Bearer " + this.getTokenForGai() ); } )
                ...
                .responseSingle( ( res, content ) -> {
                    ...
                    if ( res.status().code() == 401 ) {
                        this.updateTokens();
                        this.setInsurance( gosno, carTotalData ); }
    ...
    public void getVehicleDataTest ( String gosno, CarTotalData carTotalData ) {
        this.getHttpClient()
                .headers( h -> {
                    h.clear();
                    h.add( "Authorization", "Bearer " + this.getTokenForGai() ); } )
                ...
                .responseSingle( ( res, content ) -> {
                    ...
                    if ( res.status().code() == 401 ) {
                        this.updateTokens();
                        this.getVehicleDataTest( gosno, carTotalData ); }
    ...
    public void setTonirovka ( String gosno, CarTotalData carTotalData ) {
        this.getHttpClient()
                .headers( h -> {
                    h.clear();
                    h.add( "Authorization", "Bearer " + this.getTokenForGai() ); } )
                ...
                .responseSingle( ( res, content ) -> {
                    ...
                    if ( res.status().code() == 401 ) {
                        this.updateTokens();
                        this.setTonirovka( gosno, carTotalData ); }
    ...
    public void setGetViolationList ( String gosno, CarTotalData carTotalData ) {
        this.getHttpClient()
                .headers( h -> {
                    h.clear();
                    h.add( "Authorization", "Bearer " + this.getTokenForGai() ); } )
    ...
    public void setDoverennostList ( String gosno, CarTotalData carTotalData ) {
        this.getHttpClient()
                .headers( h -> {
                    h.clear();
                    h.add( "Authorization", "Bearer " + this.getTokenForGai() ); } )
                ...
                .responseSingle( ( res, content ) -> {
                    ...
                    if ( res.status().code() == 401 ) {
                        this.updateTokens();
                        this.setDoverennostList( gosno, carTotalData ); }
    ...
    public PsychologyCard getPsychologyCard ( com.ssd.mvd.entity.modelForPassport.Data data,
        ...
        this.getPinfl().apply( data.getPerson().getPinpp() )
                .subscribe( psychologyCard::setPinpp );
