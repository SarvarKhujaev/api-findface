...
public class SerDes implements Runnable {
    ...
    private final HttpClient httpClient = HttpClient.create().keepAlive( false );
...
//                            return this.getDeserialize().apply( pinfl ); }
    ...
    private final Function< String, Mono< String > > getImageByPinfl = pinfl -> Mono.justOrEmpty(
            this.getHttpClient()
...
//                            return getGetImageByPinfl().apply( pinfl ); }
    ...
    private final Function< String, Mono< ModelForAddress > > getModelForAddress = pinfl -> Mono.justOrEmpty(
            this.getHttpClient()
                    .headers( h -> h.add( "Authorization", "Bearer " + this.getTokenForGai() ) )
                    .post()
...
//                            return this.getGetModelForAddress().apply( pinfl ); }
    ...
    private final BiFunction< String, String, Mono< com.ssd.mvd.entity.modelForPassport.Data > > getModelForPassport =
        ( SerialNumber, BirthDate ) -> Mono.justOrEmpty(
                this.getHttpClient()
                        .headers( h -> h.add( "Authorization", "Bearer " + this.getTokenForPassport() ) )
                        .post()
...
//                            return this.getInsurance().apply( gosno ); }
    ...
    private final Function< String, Mono< ModelForCar > > getVehicleData = gosno -> Mono.justOrEmpty(
            this.getHttpClient()
                    .headers( h -> h.add( "Authorization", "Bearer " + this.getTokenForGai() ) )
                    .get()
...
//                            return this.getGetVehicleData().apply( gosno ); }
    ...
    private final Function< String, Mono< Tonirovka > > getVehicleTonirovka = gosno -> Mono.justOrEmpty(
            this.getHttpClient()
                    .headers( h -> h.add( "Authorization", "Bearer " + this.getTokenForGai() ) )
                    .get()
...
//                            return this.getGetVehicleTonirovka().apply( gosno ); }
    ...
    private final Function< String, Mono< ViolationsList > > getViolationList = gosno -> Mono.justOrEmpty(
            this.getHttpClient()
                    .headers( h -> h.add( "Authorization", "Bearer " + this.getTokenForGai() ) )
                    .get()
...
//                            return this.getViolationList.apply( gosno ); }
    ...
    private final Function< String, Mono< DoverennostList > > getDoverennostList = gosno -> Mono.justOrEmpty(
            this.getHttpClient()
                    .headers( h -> h.add( "Authorization", "Bearer " + this.getTokenForGai() ) )
                    .get()
...
//                            return this.getDoverennostList.apply( gosno ); }
    ...
    private final Function< String, Mono< ModelForCarList > > getModelForCarList = pinfl -> Mono.justOrEmpty(
            this.getHttpClient()
                    .headers( h -> h.add( "Authorization", "Bearer " + this.getTokenForGai() ) )
                    .get()
...
//                            return this.getModelForCarList.apply( pinfl ); }
                    ...
                    .onErrorReturn( new ModelForCarList( this.getServiceErrorResponse.apply( Errors.SERVICE_WORK_ERROR.name() ) ) )
                    .block() );
...
//                    return this.getPersonTotalDataByFIO.apply( fio ); }
                ...
                return res.status().code() == 200
                        ...
                        .map( s -> {
                            ...
                            if ( person != null && person.getData().size() > 0 ) {
                                ...
                                this.saveUserUsageLog( new UserRequest( person, fio ) ); }
    ...
    public PsychologyCard getPsychologyCard ( ApiResponseModel apiResponseModel ) {
        ...
        this.saveUserUsageLog( new UserRequest( psychologyCard, apiResponseModel ) );
    ...
    public PsychologyCard getPsychologyCard ( com.ssd.mvd.entity.modelForPassport.Data data,
        ...
        this.getPinfl().apply( data.getPerson().getPinpp() ).subscribe( psychologyCard::setPinpp );
