...
public class Archive {
    ...
    public String save ( PreferenceItem preferenceItem ) {
        System.out.println( preferenceItem.getId() );
        CarTotalData carTotalData = CarTotalData.builder().cameraImage( preferenceItem.getFullframe() )
                ...
                this.getPreferenceItemMapForCar().put( preferenceItem.getId(), carTotalData );
                return Serdes.getInstance().serialize( carTotalData ); }
    ...
    public Flux< CarTotalData > getAll () { return Flux.fromStream( this.getPreferenceItemMapForCar().values().stream() ); }
}
